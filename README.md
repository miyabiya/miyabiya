...
![Radix UI](https://img.shields.io/badge/-Radix_UI-161618?style=flat&logoColor=white)
...
![React Three Fiber](https://img.shields.io/badge/-R3F-000000?style=flat&logo=three.js&logoColor=white)
![MediaPipe](https://img.shields.io/badge/-MediaPipe-0097A7?style=flat&logo=google&logoColor=white)
![ONNX Runtime](https://img.shields.io/badge/-ONNX_Runtime-005CED?style=flat&logoColor=white)
![Fabric.js](https://img.shields.io/badge/-Fabric.js-333333?style=flat&logoColor=white)
...
![LINE](https://img.shields.io/badge/-LINE_Bot-00C300?style=flat&logo=line&logoColor=white)
...
## :sparkles: Recent Highlights (2025–2026)

- :factory: **Manufacturing SaaS (0→1)** — Next.js 16 + Rails 7 + Strapi 5 + Three.js. Hierarchical pricing engine, 8-stage order workflow, and a **3D product viewer that recreates Apple-style cinema-grade lighting on the web** (Three-Point Lighting + ACESFilmic tone mapping + Lightformer environment lighting)
- :nail_care: **WebGL Nail Art Preview + AR** — **Photorealistic 3D hand rendering entirely in the browser** using PBR materials, a custom Canvas 2D texture compositing pipeline, and ink-drip fluid animation (605-line HandModel). AR hand tracking via MediaPipe + ONNX Runtime Web
- :newspaper: **Headless CMS Platform** — Next.js + Strapi 5 with Container/Presenter architecture, draft mode, cache-tag revalidation, and full SEO suite
- :brain: **LLM Resume Parsing** — AI-powered resume analysis integrated into a recruitment SaaS Rails API
- :people_holding_hands: **Internal HR System (0→1)** — Rails-based candidate scoring, interview pipeline, and automated fee calculation
- :rocket: **20+ Landing Pages in One Month** — Rapid page production for a customer success platform
- :bar_chart: **10,000+ commits across 45 repos** in the 2025–2026 period
...
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=miyabiya&theme=tokyo-night&hide_border=true" alt="Activity Graph" />
</p>
...
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mitsumasa-yamaga-167a34146/)
